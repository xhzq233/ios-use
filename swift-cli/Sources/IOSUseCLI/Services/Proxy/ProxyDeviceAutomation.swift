...
enum ProxyDeviceAutomation {
    ...
    static func installAndTrustCA(
        ...
        append(&output, try execute(.swipe(to: nil, from: "关于本机", find: "关于本机", dir: nil, distance: nil, traits: nil, cindex: nil, postDom: nil), session: session, activeDriver: activeDriver, paths: paths, interruptMonitor: interruptMonitor))
        ...
        append(&output, try execute(.swipe(to: nil, from: "iOS版本", find: "证书信任设置", dir: nil, distance: nil, traits: nil, cindex: nil, postDom: nil), session: session, activeDriver: activeDriver, paths: paths, interruptMonitor: interruptMonitor))
    ...
    static func configureWiFi(
        ...
        append(&output, try execute(.swipe(to: nil, from: "自动加入", find: "配置代理", dir: nil, distance: nil, traits: nil, cindex: nil, postDom: nil), session: session, activeDriver: activeDriver, paths: paths, interruptMonitor: interruptMonitor))
