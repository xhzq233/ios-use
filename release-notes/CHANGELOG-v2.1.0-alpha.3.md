...
- Build scripts support macOS system Bash 3.2 when platform-specific options
  are absent. Alpha.2 did not publish release assets because of this build issue.
