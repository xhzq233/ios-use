...
/// Monotonically increases only after UIApplication has synchronously
/// accepted a synthesized UIEvent. Runtime automation uses this as delivery
/// evidence instead of treating a queued run-loop source as success.
