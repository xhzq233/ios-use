export const flowCaseMetadata = [
  ...
  { id: 'FLOW-15', group: 'flow', kind: 'oslog-timeout', setup: 'flow fixtures', assertion: 'oslog timeout command succeeds', coverage: 'simulator' },
...
export function buildFlowCases(ctx) {
  ...
  return [
    ...
    { id: 'FLOW-15', run: () => runCase('FLOW-15', flowArgs('oslog-timeout.yaml'), flowSetup()) },
