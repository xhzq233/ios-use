export const flowCaseMetadata = [
  ...
  { id: 'FLOW-28', group: 'flow', kind: 'post-dom-mutation', setup: 'flow fixtures and settings home', assertion: 'tap.dom appends delayed fresh DOM', coverage: 'simulator' },
  { id: 'FLOW-29', group: 'flow', kind: 'flow-error', setup: 'flow fixtures', assertion: 'tap.dom zero milliseconds is rejected', coverage: 'simulator' },
...
export function buildFlowCases(ctx) {
  ...
  return [
    ...
    { id: 'FLOW-28', run: () => runCaseContains('FLOW-28', 'DOM after 100ms\nApp: com.apple.Preferences', flowArgs('tap-dom.yaml'), flowSetup(settingsHome)) },
    { id: 'FLOW-29', run: () => runCaseFailsContains('FLOW-29', 'tap.dom must be at least 100ms', flowArgs('tap-dom-zero.yaml'), flowSetup()) },
