export const settingsBeforeContactsCaseMetadata = [
  ...
  { id: 'AS-9', group: 'settings', kind: 'post-dom-mutation', setup: 'settings home', assertion: 'bare tap --dom appends quiescence fresh DOM', coverage: 'simulator' },
  { id: 'AS-9B', group: 'settings', kind: 'post-dom-mutation', setup: 'settings home', assertion: 'tap --dom 100 appends delayed fresh DOM', coverage: 'simulator' },
  { id: 'AS-9C', group: 'settings', kind: 'parser-error', setup: 'settings home', assertion: 'tap --dom 0 is rejected', coverage: 'simulator' },
...
export function buildSettingsBeforeContactsCases(ctx) {
  ...
  return [
    ...
    { id: 'AS-9B', run: () => runCaseContains('AS-9B', 'DOM after 100ms\nApp: com.apple.Preferences', ['tap', 'com.apple.settings.general', '--traits', 'Button', '--dom', '100'], settingsHome) },
    { id: 'AS-9C', run: () => runCaseFailsContains('AS-9C', '--dom must be at least 100ms', ['tap', 'com.apple.settings.general', '--traits', 'Button', '--dom', '0'], settingsHome) },
    ...
    { id: 'SW-12', run: () => runCaseFailsMatches('SW-12', /not found|suggestions|boundary|limit/i, ['swipe', '--from', 'About', '--find', '__ios_use_missing_label__'], generalPage) },
    { id: 'SW-13', run: () => runCaseContains('SW-13', 'scrolls=', ['swipe', '--from', 'com.apple.settings.general', '--find', 'com.apple.settings.general'], settingsHome) },
    { id: 'SW-14', run: () => runCaseContains('SW-14', 'scrolls=', ['swipe', '--from', 'com.apple.settings.general', '--find', 'com.apple.settings.general'], settingsHome) },
    { id: 'SW-15', run: () => runCaseContains('SW-15', 'scrolls=', ['swipe', '--find', 'com.apple.settings.general', '--from', 'com.apple.settings.general'], settingsHome) },
    { id: 'SW-17', run: () => runCaseContains('SW-17', 'scrolls=', ['swipe', '--from', 'com.apple.settings.general', '--find', 'com.apple.settings.general', '--traits', 'Button'], settingsHome) },
    { id: 'SW-1', run: () => runCaseContains('SW-1', 'scrolls=', ['swipe', '--from', 'About', '--find', 'Keyboard', '--traits', 'Cell'], generalPage) },
